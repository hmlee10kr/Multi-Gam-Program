...
public class threeGames extends JFrame {
	...
	private JFrame t;
	private JPanel primary = new JPanel();// 모든 정보들을 담을 패널
	private JPanel ScreenOne = new JPanel();// game image을 담을 패널
	private JPanel game1 = new JPanel();// 오델로
	private JPanel game2 = new JPanel();// 테트리스

	private Mou ML;// 패널에 수행하는 일을

	// game menu mouseExited image
	private ImageIcon preImage1, preImage2;
	// game menu mouseEntered image
	private ImageIcon postImage1, postImage2;
	...
	/*
	 * private boolean isMainScreen = true; private boolean isRhythmGameMainScreen =
	 * false; private boolean isRhythmGameSelectScreen = false;
	 */
	// 메인 백에 쓸것
